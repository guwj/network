...
public class RequestHandler extends Thread {
	...
	public void run() {
		try {
			...
			} else if("POST".equals(tokens[0]) == true ||
					  "DELETE".equals(tokens[0]) == true||
					  "PUT".equals(tokens[0]) == true||
					  "Etc".equals(tokens[0]) == true ){ 
	...
	public void responseStaticResource( OutputStream outputStream, String url, String protocol )
		throws IOException {
		...
		//nio
		byte[] body = Files.readAllBytes( file.toPath() );		//--------------toPath()가 무엇인지..
